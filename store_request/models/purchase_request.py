...
class PurchaseRequest(models.Model):
    ...
    store_request_id = fields.Many2one('store.request', string='Store Request', required=False)
    ...
    checked_date = fields.Date(string='Submitted Date', readonly=True,)
